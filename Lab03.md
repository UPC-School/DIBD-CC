# Lab session #3: Programming your cloud infrastructure


## Task 3.1: Bootstrap the creation of your web server
...
**Q311.** What happens when you use https://your-load-balancer-url instead of http://your-load-balancer-url ? Why does that happen? How could you fix it?

**Q312.** Stop all three EC2 instances and wait aprox. 5 minutes. What happens? Why?

**Q313.** Terminate all three EC2 instances and wait aprox. 5 minutes. What happens? Why?

**Q314.** How are you going to end this section regarding the use of AWS resources?

### Task 3.2: Amazon DynamoDB
...
**Q321.** What is the list of events that the above URL triggers? 

**Q322.** Does the reply of the above URL match what it should be expected? Why?
...
**Q323.** Explain what happens (actions and parts activated) when you type the URL in your browser to obtain the page updated with the shopping list.

**Q324.** Explain what happens (actions and parts activated) when you type a new item in the New Thing box.
...
**Q325.** Have you been able to debug the code of the Lambda function? If the answer is yes, check that you are using the root API keys. Erase such keys and create a new testing user with the required permissions.

**Q326.** What are the minimum permissions that the user's API keys needs to execute the Lambda function locally?
